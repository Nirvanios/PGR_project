...
objl::Mesh::Mesh(std::vector<objl::Vertex> &_Vertices, std::vector<unsigned int> &_Indices) {
  Vertices = _Vertices;
  Indices = _Indices;
}
...
template<class T>
const T &objl::algorithm::getElement(const std::vector<T> &elements, std::string &index) {
...
void objl::Loader::GenVerticesFromRawOBJ(std::vector<objl::Vertex> &oVerts,
                                         const std::vector<objl::Vector3> &iPositions,
                                         const std::vector<objl::Vector2> &iTCoords,
                                         const std::vector<objl::Vector3> &iNormals,
                                         std::string icurline) {
...
void objl::Loader::VertexTriangluation(std::vector<unsigned int> &oIndices, const std::vector<objl::Vertex> &iVerts) {
