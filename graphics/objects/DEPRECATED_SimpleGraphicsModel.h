...
class DEPRECATED_SimpleGraphicsModel {
 private:
  glm::vec3 position;
 ...
 protected:
 public:
  DEPRECATED_SimpleGraphicsModel(const glm::vec3 &position, float *vertices, int verticesSize, unsigned char *indices, int indiciesSize)
