      ...
      switch (event.type) {
        ...
        case SDL_KEYDOWN:
          switch (event.key.keysym.sym) {
            ...
            case SDLK_s:
            case SDLK_a:
            case SDLK_d:graphicsCore.handleCameraMove(event.key.keysym.sym);
              break;
            case SDLK_r:graphicsCore.clearSelectedObjects(objects);
            ...
            case SDLK_g:
              ...
              break;
            case SDLK_o:
              if (air->getDragCoefficient() > 0.2f) {
                air->setDragCoefficient(air->getDragCoefficient() - 0.05f);
              }
              break;
            case SDLK_p:air->setDragCoefficient(air->getDragCoefficient() + 0.05f);
              break;
            case SDLK_n:graphicsCore.handleModelFill();
              break;
            case SDLK_m:graphicsCore.handleModelWireframe();
              break;
